...
public:
  ...
  grpc::ClientWriterInterface<dfs::PutChunkRequest>*
  PutChunkRaw(grpc::ClientContext*, dfs::PutChunkResponse*) override {
    return nullptr;
  }
  grpc::ClientAsyncWriterInterface<dfs::PutChunkRequest>*
  AsyncPutChunkRaw(grpc::ClientContext*, dfs::PutChunkResponse*,
                   grpc::CompletionQueue*, void*) override {
    return nullptr;
  }
  grpc::ClientAsyncWriterInterface<dfs::PutChunkRequest>*
  PrepareAsyncPutChunkRaw(grpc::ClientContext*, dfs::PutChunkResponse*,
                          grpc::CompletionQueue*) override {
    return nullptr;
  }
  grpc::ClientReaderInterface<dfs::GetChunkResponse>*
  GetChunkRaw(grpc::ClientContext*, const dfs::GetChunkRequest&) override {
    return nullptr;
  }
  grpc::ClientAsyncReaderInterface<dfs::GetChunkResponse>*
  AsyncGetChunkRaw(grpc::ClientContext*, const dfs::GetChunkRequest&,
                   grpc::CompletionQueue*, void*) override {
    return nullptr;
  }
  grpc::ClientAsyncReaderInterface<dfs::GetChunkResponse>*
  PrepareAsyncGetChunkRaw(grpc::ClientContext*, const dfs::GetChunkRequest&,
                          grpc::CompletionQueue*) override {
    return nullptr;
  }
  grpc::ClientAsyncResponseReaderInterface<dfs::DeleteChunkResponse>*
  AsyncDeleteChunkRaw(grpc::ClientContext*, const dfs::DeleteChunkRequest&,
                      grpc::CompletionQueue*) override {
    return nullptr;
  }
  grpc::ClientAsyncResponseReaderInterface<dfs::DeleteChunkResponse>*
  PrepareAsyncDeleteChunkRaw(grpc::ClientContext*,
                             const dfs::DeleteChunkRequest&,
                             grpc::CompletionQueue*) override {
    return nullptr;
  }
  ...
  MOCK_METHOD(grpc::Status, DeleteChunk,
              (grpc::ClientContext*, const dfs::DeleteChunkRequest&,
               dfs::DeleteChunkResponse*));
};
